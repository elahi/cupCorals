...
# FOR ORIGINAL CALIFORNIA POPULATION
# USES UNCORRECTED EMBRYO FUNCTION FOR
...
density.q
#write.csv(data.frame(density.q), "baelDensity.csv")
...
#write.csv(dT3e, "recruitDatPresent.csv")
...
#write.csv(adultDens3, "adultRecDensPresent_150411.csv")
...
# 3. embryos: linear regression; UNCORRECTED
embryo.reg <- lm(mx.coral ~ areaR, data = ltDat[ltDat$Vol.mid > 75, ])
summary(embryo.reg)
